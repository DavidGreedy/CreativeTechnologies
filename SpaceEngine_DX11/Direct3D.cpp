...
void Direct3D::operator delete(void* memoryBlockPtr)
{
...
bool Direct3D::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	rasterDesc.CullMode = cullingMode ? D3D11_CULL_NONE : D3D11_CULL_BACK;
	rasterDesc.DepthBias = 0;
	rasterDesc.DepthBiasClamp = 0.0f;
	rasterDesc.DepthClipEnable = true;
	rasterDesc.FillMode = isWireframe ? D3D11_FILL_WIREFRAME : D3D11_FILL_SOLID;
	...
	XMStoreFloat4x4(&mprojectionMatrix, DirectX::XMMatrixPerspectiveFovLH(fieldOfView, screenAspect, screenNear, screenDepth));
	...
	XMStoreFloat4x4(&morthoMatrix, DirectX::XMMatrixOrthographicLH((float)screenWidth, (float)screenHeight, screenNear, screenDepth));
